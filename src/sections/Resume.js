          ...
          <section id="about">
            ...
            <article className="article">
              <p className="summary">
                ...
                relational database management. I build software to create
                modern solutions, historically for antiquated industries such as
              ...
              <p className="summary-small">
                Although I am a seasoned entrepreneur and business
                administrator, I'm looking for a technical, non-management,
                opportunity as a software developer. Throughout my entire
                career, I have had few opportunities to work on software
                projects with a team. My goal is to gain more experience working
                with a team to gain a better understanding of the team dynamic
                in the software space. I am very passionate about, and enjoy
                learning programming languages, frameworks, libraries, and
            ...
            <div className="stack">
              <article>
                ...
                <p className="summary">
                  ...
                  Accounts Receivable Management industry. We're helping
                  lenders, debt buyers, and collection agencies to increase
                  liquidation, compliance, and revenue with the use of modern
                  web technologies.
                </p>
                <p className="summary-small">
                  <strong>Database, Server, and ORM</strong>
                  <br />I built the core software from the ground up starting
                  with a MySQL database that could accommodate new and legacy
                  data. My next task was to build a REST API as a middle-layer
                  for accessing data from an Express server built on Node.js. I
                ...
                <p className="summary-small">
                  ...
                  <br />
                  Once the database, server, API, and ORM were operational, I
                  used Vue.js and Vuetify to craft a material design inspired
                  client-side interface, designed to be familiar to industry
                  veterans, while steering them into modern best-practices. I
                  then created connections to a number of services such as
                  Stripe, SendGrid, Twilio, Firebase, Firestore, and numerous
                  high risk payment processors and gateways.
                </p>
                <p className="summary-small">
                  <strong>Team and Refactor</strong>
                  <br />
                  After winning the Pioneer startup competition with this
                  project, I hired another Node.js developer to help build
                  integrations to third party services. In order to assure
                  productivity for a new team member who was unfamiliar with the
                  structure, I refactored the back-end codebase from JavaScript
                  to Typescript. This allowed for exponentially better
                  intellisense, documentation, code navigation, and debugging.
                </p>
                <p className="summary-small">
                  <strong>DevOps</strong>
                  <br />
                  The app was originally hosted across Firebase, Digital Ocean
                  and Router Hosting. I was tasked with migrating to Google
                  Cloud to consolidate the development process, and then to
                  containerize and migrate to Zeet.co for a lower cost to
                  operate.
                </p>
              </article>
              <article>
                ...
                <p className="summary">
                  Developing small business automation tools and online
                  utilities aimed at financial institutions.
                </p>
                <p className="summary">
                ...
                <ul className="small-list">
                  ...
                  <li>
                    ...
                    integrations with SaaS products to develop an admin
                    dashboard for companies to use to manage their businesses
                    from one place.
                  </li>
                </ul>
              </article>
              ...
              <article>
                ...
                <ul className="small-list">
                  <li>
                    Leveraging solutions using MySQL, the .NET Framework, C#,
                    and SaaS products to maximize the return on investment for
              ...
              <article>
                ...
                <ul className="small-list">
                  <li>
                    ...
                    competing agencies to constantly improve our reach within
                    the industry and to source valuable charged-off receivables.
                  </li>
                  <li>
                  ...
                  <li>
                    I was responsible for Compliance, HR, Accounting,
                    Management, Hiring, Training, Team Building, and Business
                    Development were all as a small-business owner.
                  </li>
                </ul>
              </article>
              <article>
                ...
                <ul className="small-list">
                  <li>
                    ...
                    of a focus on providing technical services for other
                    agencies to supplement the strategic investments.
                  </li>
                  <li>
          ...
          <section id="publications">
            ...
            <div className="stack">
              <article>
                ...
                <p className="summary">
                  This article was originally published for the RMA
                  International Summit (formerly known as the DBA International
                  Summit). This was adapted to a digital article and expanded at
                  the request of the readers. This serves as a lead-funnel to
                  this day.
                </p>
              </article>
            </div>
